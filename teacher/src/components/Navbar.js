      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: 'Class 1-5', href: '#' },
            { name: 'Class 6-8', href: '#' },
            { name: 'Class 9 & 10', href: '#' },
            { name: 'Class 11 & 12', href: '#' },
          ],
        },
        {
          id: 'Other Subjects',
          name: 'Other Subjects',
          items: [
            { name: 'Computer Skill', href: '#' },
            { name: 'Crafts & Arts', href: '#' },
                                  ...
                                  <div className="mx-auto max-w-7xl px-8">
                                    <div className="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                                      ...
                                      <div className="row-start-1 grid grid-cols-3 gap-x-8 gap-y-10 text-sm">
                                        {category.sections.map((section) => (
                                          <div key={section.name}>
                                            <p id={`${section.name}-heading`} className="font-semibold text-indigo-700 uppercase">
                                              {section.name}
                                            </p>
                                            <ul
                                              role="list"
                                            ...
                                            >
                                              {section.items.map((item) => (
                                                <li key={item.name} className="flex">
                                                  {item.name === "Browse All" ? (<a href={item.href} className="text-indigo-700 hover:text-indigo-800">
                                                    {item.name}
                                                  </a>) : (<a href={item.href} className="hover:text-gray-800">
                                                    {item.name}
                                                  </a>)}
                                                </li>
                                              ))}
                ...
                <div className="ml-auto flex items-center">
                  {isAuthenticate ? (
                      ...
                      <div className="ml-4 mt-2 flow-root lg:ml-6">
                        {isAuthenticate ? (
                          <div className=" flex relative space-x-5 justify-center items-center pl-2">
                            <div as="div" className="relative inline-block text-left" onClick={() => navigate("/chat")}>
                              <div>
                                <div className="inline-flex focus:outline-none border-none outline-none rounded-md text-sm font-medium text-black">
                                    ...
                                    <Menu.Item>
                                      {({ active }) => (
                                        <button
                                          tabIndex="-1"
                                          role="menuitem"
                                          className={`${active ? "text-blue-gray-900" : "text-blue-gray-700"
                                            } flex w-full cursor-pointer bg-blue-gray-50 select-none items-center justify-center gap-2 rounded-md px-3 pt-[9px] pb-2 text-start leading-tight outline-none transition-all hover:bg-blue-gray-50 hover:bg-opacity-80 hover:text-blue-gray-900 focus:bg-blue-gray-50 focus:bg-opacity-80 focus:text-blue-gray-900 active:bg-blue-gray-50 active:bg-opacity-80 active:text-blue-gray-900`}                          >
                                          <div className="flex-shrink-0">
                      ...
                      <div className="hidden lg:ml-8 lg:flex">
                        {/* <a href="#" className="flex items-center text-gray-700 hover:text-gray-800">
                          <img
                            src={picture}
                            alt=""
                            className="block h-8 w-8 rounded-full flex-shrink-0"
                          />
                        </a> */}
                        <Menu as="div" className="relative inline-block text-left">
                          <div>
                    ...
                    <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                      <Link to="/login" className="text-sm font-semibold bg-[#ffcf59] rounded-full py-1 px-3 text-gray-700 hover:text-gray-800">
                        Sign in
                      </Link>
                    </div>
                  )}
